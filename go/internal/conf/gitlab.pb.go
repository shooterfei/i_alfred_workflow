...
type GitLab_ContainerExpirationPolicy struct {
	...
	KeepN     int32  `protobuf:"varint,3,opt,name=keep_n,json=keepN,proto3" json:"keep_n,omitempty"`
...
func (x *GitLab_ContainerExpirationPolicy) GetKeepN() int32 {
	if x != nil {
		return x.KeepN
	}
	return 0
...
var file_internal_conf_gitlab_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x6b, 0x65, 0x65, 0x70, 0x4e, 0x12, 0x1d, 0x0a, 0x0a,
